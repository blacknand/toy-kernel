...
- Download GCC via the GNU FTP server: https://www.gnu.org/software/gcc/mirrors.html
make sure to choose the corresponding mirror site for your location. In my case:
